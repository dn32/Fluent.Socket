...
namespace Fluent.Socket
{
    public static class FluentSocketUtil
    {
        public static async Task SendData<T>(this FluentSocket fluentSocket, T content, CancellationToken cancellationToken)
        {
            ...
            await fluentSocket.SendData(fluentMessageContract, cancellationToken);
        }

        internal static async Task SendData(this FluentSocket fluentSocket, FluentMessageContract fluentMessageContract, CancellationToken cancellationToken)
        {
